...
var Templates = {
    ...
    appTemplate : '<table id="db-tables" class="table table-bordered table-striped">' +
        ...
        '</table>',
    appIconTemplate:
        '<div class="accordion" id="app-groups-container">' +
    ...
    navBarTemplate :
        '<div class="navbar navbar-inverse">' +
            ...
            '{{#User.is_sys_admin}}<a id="adminLink" class="btn btn-inverse btn-launch btn-stack" title="Admin Console"><i class="icon-cog"></i></a>' +
